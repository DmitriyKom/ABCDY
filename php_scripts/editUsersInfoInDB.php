<?php
	/* Date         Name            Changes
	 * 12/05/2019   Andrey         Initial development
	 *	This script is for adjusting users information in DB
	 * 
	 *
	 */
	...
	header("location: ./.././editAccount.php?id=$user_id");
